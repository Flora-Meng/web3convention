		...
		<TimelineContainer>
			...
			<FirstLine>
				<Session>
					...
					<SessionInfo>A panel of judges selects the most promising teams. </SessionInfo>
				</Session>
				<Session>
				...
				<Session>
					...
					<SessionInfo>
						A prestigious panel, including representatives from the 30 VC firms, will
			...
			<SecondLine>
				<SecondSession>
					...
					<SessionInfo>Chosen teams present their pitches and demos online. </SessionInfo>
				...
				<SecondSession>
					...
					<SessionInfo>Host a welcome party in Queensland Parliament House. </SessionInfo>
				</SecondSession>
				<SecondSession>
					...
					<SessionInfo>
						Based on criteria like innovation, market potential, team capability, and
						feasibility, winners are selected.
					</SessionInfo>
					<SessionInfo>
						Post-pitch, start-ups have dedicated networking and discussion sessions with
						interested VC firms.
					</SessionInfo>
				</SecondSession>
			</SecondLine>
