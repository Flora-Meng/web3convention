...
interface ExhibitorLocationOnMapProps {
...
const ExhibitorLocationOnMap: React.FC<ExhibitorLocationOnMapProps> = ({
	exhibitorCoordinates
}) => {
...
export default ExhibitorLocationOnMap;
